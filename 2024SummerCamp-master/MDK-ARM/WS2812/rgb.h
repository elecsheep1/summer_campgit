...
/* 这里要把TIM的中断频率设置为800kHz，HIGH占比70%，LOW占比30% */
#define PERIOD 105
//#define  RGB_HIGH  70//原来的是104，这是PWM占空比对应WB2812的1码
//#define  RGB_LOW  30//原来的是52，这是PWM占空比对应WB2812的0码
#define  RGB_HIGH  (int)(PERIOD*0.7)//原来的是104，这是PWM占空比对应WB2812的1码
#define  RGB_LOW  (int)(PERIOD*0.3)//原来的是52，这是PWM占空比对应WB2812的0码
