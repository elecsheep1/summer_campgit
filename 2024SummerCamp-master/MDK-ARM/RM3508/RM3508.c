...
{
	{.Kp = 25.65,.Ki = 0.66,.Kd = 0.07,.Max = 16000,.Min = -16000,.IntegralLimit = 1000,.DeadBand = 10},	//ID = 1
	{.Kp = 24.3,.Ki = 0.7,.Kd = 0.09,.Max = 16000,.Min = -16000,.IntegralLimit = 1000,.DeadBand = 10},		//ID = 2
	{.Kp = 25.5,.Ki = 0.5,.Kd = 0.1,.Max = 16000,.Min = -16000,.IntegralLimit = 1000,.DeadBand = 10},			//ID = 3
	{.Kp = 19.45,.Ki = 0.3,.Kd = 0.08,.Max = 16000,.Min = -16000,.IntegralLimit = 1000,.DeadBand = 10},	 	//ID = 4
	/**/{.Kp = 8,.Ki = 0,.Kd = 0,.Max = 6000,.Min = -6000,.IntegralLimit = 1000,.DeadBand = 10},	 			//ID = 5
	{.Kp = 8,.Ki = 0,.Kd = 0,.Max = 10000,.Min = -10000,.IntegralLimit = 1000,.DeadBand = 10},	 					//ID = 6
	{.Kp = 8,.Ki = 0,.Kd = 0,.Max = 10000,.Min = -10000,.IntegralLimit = 1000,.DeadBand = 10},	 					//ID = 7
	{.Kp = 8,.Ki = 0,.Kd = 0,.Max = 4000,.Min = -4000,.IntegralLimit = 1000,.DeadBand = 10},	 					//ID = 8
};
/*********************************************************************************
位置PID设置： Kp    Ki     Kd
云台俯仰：   0.2  0.009   0.01
...
{
	{.Kp = 0.3,.Ki = 0.001,.Kd = 0,.Max = 14000,.Min = -14000,.IntegralLimit = 10000,.DeadBand = 200},	//ID = 1
	{.Kp = 0.3,.Ki = 0.001,.Kd = 0,.Max = 14000,.Min = -14000,.IntegralLimit = 10000,.DeadBand = 200},	//ID = 2
	{.Kp = 0.3,.Ki = 0.001,.Kd = 0,.Max = 14000,.Min = -14000,.IntegralLimit = 10000,.DeadBand = 200},	//ID = 3
	{.Kp = 0.3,.Ki = 0.001,.Kd = 0,.Max = 14000,.Min = -14000,.IntegralLimit = 10000,.DeadBand = 200},	//ID = 4
	/**/{.Kp = 0.3,.Ki = 0.001,.Kd = 0,.Max = 3000,.Min = -3000,.IntegralLimit = 15000,.DeadBand = 100},//ID = 5
	{.Kp = 0.3,.Ki = 0.03,.Kd = 0,.Max = 1500,.Min = -1500,.IntegralLimit = 25000,.DeadBand = 300},		//ID = 6
	{.Kp = 0.3,.Ki = 0.03,.Kd = 0,.Max = 1500,.Min = -1500,.IntegralLimit = 25000,.DeadBand = 300},	//ID = 7
	{.Kp = 3.2,.Ki = 0.001,.Kd = 0,.Max = 1000,.Min = -1000,.IntegralLimit = 10000,.DeadBand = 100}	//ID = 8   8 0.001 20
};
...
void RM3508_Set_Speed(int goal_speed,int ID)
{
	...
	M3508_Speed_Pid[id].Speed_last = M3508_Speed_Pid[id].NowIS; // 微分优先PID
...
//	M3508_Speed_Pid[id].D_Out = M3508_Speed_Pid[id].Kd * (M3508_Speed_Pid[id].Err - M3508_Speed_Pid[id].Err_last); 
	M3508_Speed_Pid[id].D_Out = M3508_Speed_Pid[id].Kd * (M3508_Speed_Pid[id].Speed_last - M3508_Speed_Pid[id].NowIS); // 微分优先PID
...
//	goal_cnt=RM3508_Ang2Cnt(angle,ID);//该函数为电机角度转cnt
	...
	M3508_Pos_Pid[id].Pos_last = M3508_Pos_Pid[id].NowIS; // 微分优先PID
...
//	M3508_Pos_Pid[id].D_Out = M3508_Pos_Pid[id].Kd * (M3508_Pos_Pid[id].Err - M3508_Pos_Pid[id].Err_last); 
	M3508_Pos_Pid[id].D_Out = M3508_Pos_Pid[id].Kd * (M3508_Pos_Pid[id].Pos_last - M3508_Pos_Pid[id].NowIS);  // 微分优先PID
