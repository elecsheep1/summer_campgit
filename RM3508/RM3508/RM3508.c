...
M3508_PID M3508_Speed_Pid[8] =//8 0 0    8 0 0   
{
	...
	/**/{.Kp = 8,.Ki = 0.f,.Kd = 0,.Max = 4000,.Min = -4000,.IntegralLimit = 1000,.DeadBand = 10},	 	//ID = 5
	{.Kp = 8,.Ki = 0,.Kd = 0,.Max = 9000,.Min = -9000,.IntegralLimit = 1000,.DeadBand = 10},	 	//ID = 6
	{.Kp = 8,.Ki = 0,.Kd = 0,.Max = 9000,.Min = -9000,.IntegralLimit = 1000,.DeadBand = 10},	 	//ID = 7
...
{
	{.Kp = 0.3,.Ki =0.004,.Kd = 0.001,.Max = 14000,.Min = -14000,.IntegralLimit = 10000,.DeadBand = 200},	//ID = 1
	...
	/**/{.Kp = 0.3,.Ki = 0.005,.Kd = 0,.Max = 2000,.Min = -2000,.IntegralLimit = 15000,.DeadBand = 300},	//ID = 5// 
	{.Kp = 0.3,.Ki = 0.02,.Kd = 0,.Max = 1500,.Min = -1500,.IntegralLimit = 20000,.DeadBand = 300},	//ID = 6
	{.Kp = 0.3,.Ki = 0.02,.Kd = 0,.Max = 1500,.Min = -1500,.IntegralLimit = 20000,.DeadBand = 300},	//ID = 7
...
uint8_t RM3508_Set_I(int target_i,uint8_t motor_id)
{
	if( motor_id>=1 && motor_id<=8 ) 
	{
        ...
        if(motor_id <=4 )   //前四个ID对应的sendID标识符是0x200
        {
            ...
            RM3508_Sendbuf2[2*motor_id-2]=target_i>>8;                  //电流值高8位0246,将target_i右移八位
            RM3508_Sendbuf2[2*motor_id-1]=target_i & 0x00ff;            //电流值低8位1357保留target_i的低八位
